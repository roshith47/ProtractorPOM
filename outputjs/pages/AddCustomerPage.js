    ...
    AddCustomerPage.prototype.AddCustomer = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fname.sendKeys(prop.customers.firstname)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.lname.sendKeys(prop.customers.lastname)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.postalcode.sendKeys(prop.customers.postalcode)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.addCustomerbtn.click()];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, alert_1.alert.VerifyAndCloseAlert("Customer added")];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
